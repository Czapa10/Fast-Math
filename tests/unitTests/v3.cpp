...
TEST_CASE_TEMPLATE("v3_construction and getters", t, NUMERICAL_TYPES)
{
	...
	CHECK_V3(v3_base<t>(v2_base<t>(1, 2)), 1, 2, 0);
...
TEST_CASE("v3 operations")
{
	...
	CHECK_V3(SafeHadamardDivN(A, B, v3(5)), -1, 3.f/5.f, 4.f);
	CHECK_V3(SafeHadamardDivN(A, v3(1, 0, 0), v3(5)), 2, 5, 5);
	CHECK_V3(SafeHadamardDivN(A, v3(0, 1, 1), v3(5)), 5, 3, 4);
	CHECK_V3(SafeHadamardDivN(A, v3(0.f), v3(11, 10, 9)), 11, 10, 9);
	CHECK_V3(SafeHadamardDiv1(A, B), -1, 3.f/5.f, 4.f);
	CHECK_V3(SafeHadamardDiv1(A, v3(0.f)), 1, 1, 1);
	CHECK_V3(SafeHadamardDiv0(A, B), -1, 3.f/5.f, 4.f);
	CHECK_V3(SafeHadamardDiv0(A, v3(0.f)), 0, 0, 0);
	CHECK_V3(-B, 2, -5, -1);
